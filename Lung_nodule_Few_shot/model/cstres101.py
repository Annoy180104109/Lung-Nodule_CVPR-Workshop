...
# Supports vit-small (DINO) OR resnet50 (torchvision)
# =========================
import math
import torch
...
class ClfSegTransformer(FSCSModule):
    ...
    def __init__(self, args):
        ...
        if bb in ["vit-small", "vit_small", "vit"]:
            ...
            # pseudo qkv doesn't exist in resnet; handled by feature-map pseudo

        else:
            raise ValueError(f"Unsupported backbone: {args.backbone}. Use 'vit-small' or 'resnet50'.")
